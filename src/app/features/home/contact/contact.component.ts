...
@Component({
  ...
  imports: [GlassCardComponent, GlowButtonComponent, RevealDirective],
  template: `
        ...
        <div class="contact-content">
          <div class="contact-text" appReveal="up">
            ...
            <div class="contact-cta">
              <app-glow-button variant="primary" (clicked)="sendEmail()">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
              ...
              <app-glow-button variant="secondary" (clicked)="openLinkedIn()">
              ...
              <app-glow-button variant="outline" (clicked)="openGitHub()">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path
...
export class ContactComponent {
  ...
  protected sendEmail(): void {
    this.document.defaultView?.open(`mailto:${this.profile.email}`, '_self');
  }
  ...
  protected openGitHub(): void {
    this.document.defaultView?.open(this.profile.github, '_blank', 'noopener');
  }
}
